...
//-------------------------------------------------------------------------------------------
	...
	Hitbox::Hitbox(int inputWidth, int inputHeight, 
		           float inputCornerX, float inputCornerY)
	{
...
//-------------------------------------------------------------------------------------------
	...
	void Hitbox::createHitBox(float startWidth,float startHeight, 
							  float initialPositionX,float initialPositionY)
	{
...
//-------------------------------------------------------------------------------------------
	...
	void InteractBox::InteractBoxActive(bool inputactive, bool intalk, bool inattack, 
										int indirection, float inPosX, float inPosY)
	{
		active = inputactive;
		talk = intalk;
		attack = inattack;
