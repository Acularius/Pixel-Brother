/* Prototyping with Tassos' basic engine that handles sprite loading and drawing
*  them while handling basic input (keyboard/mouse) and 
*  update events for timers/display
*/
...
/*#define WINDOW_SCREEN_WIDTH 387
#define WINDOW_SCREEN_HEIGHT 260
#define WINDOW_WIDTH 400
#define WINDOW_HEIGHT 216*/

/*#define WINDOW_SCREEN_WIDTH 100
#define WINDOW_SCREEN_HEIGHT 600
#define WINDOW_WIDTH 600
#define WINDOW_HEIGHT 400*/

#define WINDOW_SCREEN_WIDTH 464
#define WINDOW_SCREEN_HEIGHT 312
