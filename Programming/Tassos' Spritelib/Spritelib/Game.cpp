...
void Game::initializeGame()
{
	...
	animatedSprite = new Sprite("images/InternetTestSprite.png");
	animatedSprite->setNumberOfAnimations(2);
	animatedSprite->setSpriteFrameSize(32,64);
	animatedSprite->setPosition(300,200);
	animatedSprite->setLayerID(2);
	animatedSprite->addSpriteAnimFrame(0, 0, 0);
	animatedSprite->addSpriteAnimFrame(0, 0, 32);
	animatedSprite->addSpriteAnimFrame(0, 0, 64);
	animatedSprite->addSpriteAnimFrame(0, 0, 96);
	animatedSprite->addSpriteAnimFrame(0, 0, 128);
	animatedSprite->addSpriteAnimFrame(0, 0, 160);
	animatedSprite->addSpriteAnimFrame(0, 0, 192);

	/* this is how to add an entire row given the starting pixel location, spacing offset on X,Y and the number of frames to add */
	animatedSprite->addSpriteAnimRow(1, 0,0, 0, 32, 7);
	...
	animatedSprite2 = new Sprite("images/InternetTestSprite.png");
	int numRows = 4;
	animatedSprite2->setNumberOfAnimations(numRows);
	animatedSprite2->setSpriteFrameSize(32,64);
	...
	{
		float step = 32*i;
		animatedSprite2->addSpriteAnimRow(i, 0,step, 64,32, 6);
	}
